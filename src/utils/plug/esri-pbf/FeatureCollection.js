...
export const esriPBuffer = ($root.esriPBuffer = (() => {
  ...
  esriPBuffer.FeatureCollectionPBuffer = (function () {
    ...
    FeatureCollectionPBuffer.decode = function decode(reader, length) {
      ...
      let message = new $root.esriPBuffer.FeatureCollectionPBuffer();
    ...
    FeatureCollectionPBuffer.Field = (function () {
      ...
      Field.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        let message = new $root.esriPBuffer.FeatureCollectionPBuffer.Field();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
    ...
    FeatureCollectionPBuffer.Value = (function () {
      ...
      Value.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        let message = new $root.esriPBuffer.FeatureCollectionPBuffer.Value();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
    ...
    FeatureCollectionPBuffer.Geometry = (function () {
      ...
      Geometry.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        let message = new $root.esriPBuffer.FeatureCollectionPBuffer.Geometry();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 2:
    ...
    FeatureCollectionPBuffer.Feature = (function () {
      ...
      Feature.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        let message = new $root.esriPBuffer.FeatureCollectionPBuffer.Feature();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
      ...
      Feature.verify = function verify(message) {
        ...
        if (
          ...
          for (let i = 0; i < message.attributes.length; ++i) {
            let error = $root.esriPBuffer.FeatureCollectionPBuffer.Value.verify(
    ...
    FeatureCollectionPBuffer.Scale = (function () {
      ...
      Scale.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length;
        let message = new $root.esriPBuffer.FeatureCollectionPBuffer.Scale();
        while (reader.pos < end) {
          let tag = reader.uint32();
          switch (tag >>> 3) {
            case 1:
    ...
    FeatureCollectionPBuffer.Translate = (function () {
      ...
      Translate.verify = function verify(message) {
        ...
        if (
          ...
          message.hasOwnProperty('xTranslate')
        ) {
        ...
        if (
          ...
          message.hasOwnProperty('yTranslate')
        ) {
        ...
        if (
          ...
          message.hasOwnProperty('mTranslate')
        ) {
        ...
        if (
          ...
          message.hasOwnProperty('zTranslate')
        ) {
    ...
    FeatureCollectionPBuffer.Transform = (function () {
      ...
      Transform.verify = function verify(message) {
        ...
        if (message.scale != null && message.hasOwnProperty('scale')) {
          let error = $root.esriPBuffer.FeatureCollectionPBuffer.Scale.verify(
            message.scale
          );
          if (error) {
            return 'scale.' + error;
      ...
      FeatureResult.verify = function verify(message) {
        ...
        if (message.fields != null && message.hasOwnProperty('fields')) {
          ...
          for (let i = 0; i < message.fields.length; ++i) {
            let error = $root.esriPBuffer.FeatureCollectionPBuffer.Field.verify(
              message.fields[i]
            );
            if (error) {
              return 'fields.' + error;
