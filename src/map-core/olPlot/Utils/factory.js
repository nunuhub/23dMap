 ...
 * @desc 通过json获取样式
 */
import { Style, Icon, Stroke, Fill, RegularShape, Text } from 'ol/style';
...
StyleFactory.prototype._getRegularShape = function(options) {
  try {
    const regularShape = new RegularShape({
      ...
      radius1:
        typeof options.radius1 === 'number' ? options.radius1 : undefined,
      radius2:
        typeof options.radius2 === 'number' ? options.radius2 : undefined,
      angle: typeof options.angle === 'number' ? options.angle : 0,
      snapToPixel:
        typeof options.snapToPixel === 'boolean' ? options.snapToPixel : true,
      stroke: this._getStroke(options.stroke) || undefined,
      rotation: typeof options.rotation === 'number' ? options.rotation : 0,
      rotateWithView:
        typeof options.rotateWithView === 'boolean'
...
StyleFactory.prototype._getIcon = function(options) {
  try {
    ...
    const icon = new Icon({
      ...
      anchorXUnits: options.imageAnchorXUnits
        ? options.imageAnchorXUnits
        : 'fraction',
      anchorYUnits: options.imageAnchorYUnits
        ? options.imageAnchorYUnits
        : 'fraction',
      anchorOrigin: options.imageAnchorOrigin
        ? options.imageAnchorYUnits
        : 'top-left',
      ...
      rotateWithView:
        typeof options.rotateWithView === 'boolean'
          ...
          : false,
      opacity:
        typeof options.imageOpacity === 'number' ? options.imageOpacity : 1,
      rotation:
        typeof options.imageRotation === 'number' ? options.imageRotation : 0,
      size:
        options.size && Array.isArray(options.size) && options.size.length === 2
          ? options.size
          : undefined,
      imgSize:
        options.imgSize &&
        Array.isArray(options.imgSize) &&
        options.imgSize.length === 2
          ? options.imgSize
          : undefined,
...
StyleFactory.prototype._getStroke = function(options) {
  try {
    ...
    const stroke = new Stroke({
      ...
      lineCap:
        options.strokeLineCap && typeof options.strokeLineCap === 'string'
          ? options.strokeLineCap
          : 'round',
      lineJoin:
        options.strokeLineJoin && typeof options.strokeLineJoin === 'string'
          ? options.strokeLineJoin
          : 'round',
      lineDash: options.strokeLineDash ? options.strokeLineDash : undefined,
      lineDashOffset:
        typeof options.strokeLineDashOffset === 'number'
          ? options.strokeLineDashOffset
          : '0',
      miterLimit:
        typeof options.strokeMiterLimit === 'number'
...
StyleFactory.prototype._getText = function(options) {
  try {
    const text = new Text({
      font:
        options.textFont && typeof options.textFont === 'string'
          ? options.textFont
          : '10px sans-serif',
      offsetX:
        typeof options.textOffsetX === 'number' ? options.textOffsetX : 0,
      offsetY:
        typeof options.textOffsetY === 'number' ? options.textOffsetY : 0,
      scale:
        typeof options.textScale === 'number' ? options.textScale : undefined,
      rotation:
        typeof options.textRotation === 'number' ? options.textRotation : 0,
      text:
        options.text && typeof options.text === 'string'
          ? options.text
          : undefined,
      textAlign:
        options.textAlign && typeof options.textAlign === 'string'
          ? options.textAlign
          : 'start',
      textBaseline:
        options.textBaseline && typeof options.textBaseline === 'string'
